...
const words = ['çikolata', 'bot', 'odun', 'bomba', 'süt', 'şimşek', 'yıldırım', 'patlat', 'savaş', 'kelime', 'yok et', 'bilmem', 'öldür', 'sonsuzluk', 'gerçek'];
...
exports.run = async (client, msg, args) => {
  ...
  let opponent = msg.mentions.users.first()
	if (!opponent) return msg.reply(" \<a:enunlem:813340295734493184> Oynamak istediğin kişiyi etiketlemelisin!")
