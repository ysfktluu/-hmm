...
module.exports.run = async (client, message, args) => {
 if(!message.member.roles.cache.get("783240646852870205" , "782286414167015425") && !message.member.hasPermission('782286411281858570')) return message.channel.send('Bu Komutu Kullanmak İçin Yetkiniz Bulunmamakta.')
