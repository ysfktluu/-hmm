...
exports.run = async(client, message, args) => {
	...
	if(!kicklog) return message.channel.send('\<a:enhayir:813350216911683584> ``Kick Log Sistemi Ayarlanmamış.``')
  ...
  message.guild.members.cache.get(user.id).kick({
   ...
   tamam2.on('collect', async (r)=>{
     m.delete()
message.channel.send('\<a:enmavitik:839520034967257118> | **Kickleme İşlemi Başarıyla İptal Edildi**')
      })
    })
 })
} 
