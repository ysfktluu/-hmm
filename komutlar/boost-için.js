...
exports.run = function(client, message, args) {
    ...
    .setColor('RANDOM')
    .setTimestamp()
    .setTitle('\<a:kristalkalp:851411711541772348> Sunucumuza Boost Bastığın İçin Teşekkür Ederiz!')
...
exports.conf = {
  enabled: true,
  guildOnly: true,
  aliases: ["boostiçintşk"],
  permLevel: 0
};

exports.help = {
  name: 'boost-teşekkür',
  description: 'boost-teşekkür',
  usage: 'boost-teşekkür'
};