...
exports.run = async(client, message, args) => {
  ...
  message.guild.members.cache.get(user.id).ban({
    ...
    .addField('\<a:enmavitik:839520034967257118> Yetkili', `${message.author.tag}`)
    .addField('\<a:enmavitik:839520034967257118> Banlanan kişi', user)
    .addField('\<a:enmavitik:839520034967257118>  Sebep', sebep)
   ...
   tamam2.on('collect', async (r)=>{
     m.delete()
message.channel.send('\<a:enmavitik:839520034967257118> | **Banlama İşlemi Başarıyla İptal Edildi.**')
      })
    })
 })
} 
