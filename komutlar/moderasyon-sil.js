...
exports.run = function(client, message, args) {
  if (!message.member.hasPermission("MANAGE_MESSAGES")) {
    const embed = new Discord.MessageEmbed()
      .setColor("BLACK")
      .setDescription(`\<a:enunlem:813340295734493184> Ne yazıkki bu komutu kullanmaya yetkiniz yok!`)
  ...
  if (!args[0]) {
    const embed = new Discord.MessageEmbed()
      .setColor("BLACK")
      .setDescription(` \<a:enyanlis:813339775338545154> Lütfen silinecek mesaj sayısını belirtiniz.`)
      .setFooter(client.user.username, client.user.avatarURL());
