...
if(message.author.id != "477189482206986240") if(message.author.id != "523218862766948362") return message.channel.send(bakim)
  ...
  if (!soyisim) return message.channel.send("\<a:krmzhayir:853567840085737492> | **Lütfen Soyismini yaz.**");
  message.channel.send("\<a:krmztik:853356106955751504> | **Soy İsmin ``" + soyisim + "`` olarak ayarlandı!**");
